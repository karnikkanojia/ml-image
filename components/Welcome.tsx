  ...
  return (
    <Card>
      ...
      <CardContent>
        ...
        access to advanced medical technologies through the power of artificial
        intelligence. This platform is a testament to
        ...
        influenced the AI&apos;s assessments, thereby enhancing the clarity and
        usefulness of the analysis. Created and hosted by MI4People, X-Ray
        ...
        practical applications in medical settings, we aim to empower healthcare
        professionals worldwide with tools that are not only innovative but also
        accessible and easy to use. This initiative is particularly aimed at
        supporting medical practitioners in developing countries, providing them
        with access to diagnostic tools that were previously out of reach due to
        technological and financial constraints. This application is more than
        just a tool; it&apos;s a part of MI4People&apos;s vision to harness the
        potential of AI for positive social impact, making significant strides
        towards leveling the playing field in global health.
        <Alert variant="destructive" className="border-none p-0 text-lg">
          <AlertTitle className="mt-4">Disclaimer</AlertTitle>
          <AlertDescription>
            ...
            sensitive data or identifiers before submission. It is the
            user&apos;s responsibility to comply with all applicable privacy and
            data protection laws, including the anonymization of images to
            remove any information that could potentially identify an
            individual. By proceeding to use this application, users agree to
            this responsibility and to the terms outlined above.
          </AlertDescription>
        </Alert>
      </CardContent>
      <CardFooter>
